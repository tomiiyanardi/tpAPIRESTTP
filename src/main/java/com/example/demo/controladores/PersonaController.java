...
import com.example.demo.servicios.PersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<?> getAll() {
        try {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("{\"error\":\"Error xfa intente mas tarde.\"}");
        }
    }
    ...
    public ResponseEntity<?> save(@RequestBody Persona entity) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"error\":\"Error xfa intente mas tarde.\"}");
        }
    }
